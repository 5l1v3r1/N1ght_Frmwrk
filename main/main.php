...
function indexold(){
    ...
    print "$purple        .---.        .-----------                      \n";
    print "$purple       /     \  __  /    ------                        \n";
    print "$purple      / /     \(  )/    ----- $white    N1ght.Frmwrk$purple V.3.0\n";
...
function bukalapak(){
    ...
    echo "$okegreen\n ($cyan Hax0r$okegreen )$white- on -$okegreen($white ~/Menu/Generator/Bukalapak$okegreen ) \n$red >$white ";
    $menu = trim(fgets(STDIN));
    if ($menu == 1 OR $menu == 01){
...
function gojek(){
    ...
    echo "$okegreen\n ($cyan Hax0r$okegreen )$white- on -$okegreen($white ~/Menu/Generator/Gojek$okegreen ) \n$red >$white ";
    $menu = trim(fgets(STDIN));
    if ($menu == 1 OR $menu == 01){
        echo "$cyan Jumlah$red >$white ";
        $jumlah = trim(fgets(STDIN));
